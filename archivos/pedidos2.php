...
*/
    ...
    function get_order_detailsGustavo($order_id){
...
<ul class="navbar-nav mr-auto">
       ...
       <ul class="navbar-nav">
            ...
            <input type="hidden" id="Totalsegundos2$order_id" value="$todosLosSegundos2">
               ...
               <span class="blanca_letra"  id="horas2$order_id">$tiempoH2 qqq</span>
            </li>
        </ul>
...
EOL;
                ...
                if($order->get_status() === "processing") {
                    ...
                    echo <<<EOL
                     ...
                     <select id="motormans-$order_id" class="form-control-sm mr-1" style="display:none;">$selLibres</select>
                     <button class="btn btn-warning boton" data-id="$order_id" style="display:none;" >Asignar</button>&nbsp;
                ...
                <form id="woofood_complete_order_form_$order_id" action="" method="POST" class="form-inline">
                    ...
                    <input type="hidden" name="order_id" value="$order_id"/>
                    <button class="btn btn-success"  type="submit">El pedido esta listo para enviarse</button>&nbsp;&nbsp;&nbsp;&nbsp;
                </form>
...
EOL;
                ...
                if($order->get_status() === "motorista_rechaza") {
                    ...
                    echo <<<EOL
                     ...
                     <select id="motormans-$order_id" style="display:none;">$selLibres</select>
                     <button class="btn btn-warning boton" data-id="$order_id" style="display:none;" >Asignar</button>&nbsp;
...
ETE;
        ...
        foreach($order_list as $uu){
          ...
          $uu = $order->get_id();
            ...
            echo get_order_detailsGustavo($uu);
